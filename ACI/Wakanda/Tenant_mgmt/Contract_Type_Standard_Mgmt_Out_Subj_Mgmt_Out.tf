...
*/
resource "aci_contract_subject" "Tenant_mgmt_Contract_Type_Standard_Mgmt_Out_Subj_Mgmt_Out" {
    depends_on                      = [
        aci_contract.Tenant_mgmt_Contract_Type_Standard_Mgmt_Out,
        aci_filter.Tenant_mgmt_Filter_Mgmt_Out,
    ]
    contract_dn                     = aci_contract.Tenant_mgmt_Contract_Type_Standard_Mgmt_Out.id
    name                            = "Mgmt_Out"
