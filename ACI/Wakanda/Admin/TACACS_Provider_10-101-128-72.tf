...
API Information:
 ...
 - Distinguished Name: "uni/fabric/tacacsgroup-default/tacacsdest-10.101.128.72-port-49"
GUI Location:
 - Admin > External Data Collectors > Monitoring Destinations > TACACS > default > [TACACS Destinations]
*/
resource "aci_rest" "TACACS_Accounting_DestGrp_default_Server_10-101-128-72" {
    depends_on  = [
...
API Information:
 ...
 - Distinguished Name: "userext/tacacsext/tacacsplusprovider-10.101.128.72"
GUI Location:
 - Admin > AAA > Authentication:TACACS > Create TACACS Provider
*/
resource "aci_rest" "TACACS_Provider_10-101-128-72" {
...
API Information:
 ...
 - Distinguished Name: "uni/userext/tacacsext/tacacsplusprovidergroup-RICH/providerref-10.101.128.72"
GUI Location:
 - Admin > AAA > Authentication:AAA > Login Domain
*/
resource "aci_rest" "Login_Domain_RICH_TACACS_Provider_10-101-128-72" {
    depends_on  = [
