...
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v2101"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2101
*/
resource "aci_bridge_domain" "Tenant_prod_Bridge_Domain_v2101" {
    depends_on                                  = [
...
API Information:
 - Class: "fvSubnet"
 - Distinguished Name: "/uni/tn-prod/BD-v2101/subnet-[10.96.101.1/24]"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2101 > Subnets
*/
resource "aci_subnet" "Tenant_prod_Bridge_Domain_v2101_Subnet_10-96-101-0_24" {
    depends_on                          = [
        aci_tenant.Tenant_prod,
        aci_bridge_domain.Tenant_prod_Bridge_Domain_v2101
    ]
    parent_dn                           = aci_bridge_domain.Tenant_prod_Bridge_Domain_v2101.id
    ctrl                                = ["nd"]
    description                         = "Site Local Vlan2101"
    ip                                  = "10.96.101.1/24"
    preferred                           = "no"
    scope                               = ["public"]
    virtual                             = "no"
