...
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v2111"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2111
*/
resource "aci_bridge_domain" "Tenant_prod_Bridge_Domain_v2111" {
    depends_on                                  = [
...
API Information:
 - Class: "fvSubnet"
 - Distinguished Name: "/uni/tn-prod/BD-v2111/subnet-[10.96.111.1/24]"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2111 > Subnets
*/
resource "aci_subnet" "Tenant_prod_Bridge_Domain_v2111_Subnet_10-96-111-0_24" {
    depends_on                          = [
        aci_tenant.Tenant_prod,
        aci_bridge_domain.Tenant_prod_Bridge_Domain_v2111
    ]
    parent_dn                           = aci_bridge_domain.Tenant_prod_Bridge_Domain_v2111.id
    ctrl                                = ["nd"]
    description                         = "Panther Devo Testing"
    ip                                  = "10.96.111.1/24"
    preferred                           = "no"
    scope                               = ["public"]
    virtual                             = "no"
