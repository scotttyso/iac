...
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v2104"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2104
*/
resource "aci_bridge_domain" "Tenant_prod_Bridge_Domain_v2104" {
    depends_on                                  = [
...
API Information:
 - Class: "fvSubnet"
 - Distinguished Name: "/uni/tn-prod/BD-v2104/subnet-[10.96.104.1/24]"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2104 > Subnets
*/
resource "aci_subnet" "Tenant_prod_Bridge_Domain_v2104_Subnet_10-96-104-0_24" {
    depends_on                          = [
        aci_tenant.Tenant_prod,
        aci_bridge_domain.Tenant_prod_Bridge_Domain_v2104
    ]
    parent_dn                           = aci_bridge_domain.Tenant_prod_Bridge_Domain_v2104.id
    ctrl                                = ["nd"]
    description                         = "Panther iSCSI"
    ip                                  = "10.96.104.1/24"
    preferred                           = "no"
