...
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v2110"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2110
*/
resource "aci_bridge_domain" "Tenant_prod_Bridge_Domain_v2110" {
    depends_on                                  = [
    ...
    description                                 = "Panther VM Network1"
    name                                        = "v2110"
    arp_flood                                   = "no"
...
API Information:
 - Class: "fvSubnet"
 - Distinguished Name: "/uni/tn-prod/BD-v2110/subnet-[10.96.110.1/24]"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v2110 > Subnets
*/
resource "aci_subnet" "Tenant_prod_Bridge_Domain_v2110_Subnet_10-96-110-0_24" {
    depends_on                          = [
        aci_tenant.Tenant_prod,
        aci_bridge_domain.Tenant_prod_Bridge_Domain_v2110
    ]
    parent_dn                           = aci_bridge_domain.Tenant_prod_Bridge_Domain_v2110.id
    ctrl                                = ["nd"]
    description                         = "Panther VM Network1"
    ip                                  = "10.96.110.1/24"
    preferred                           = "no"
