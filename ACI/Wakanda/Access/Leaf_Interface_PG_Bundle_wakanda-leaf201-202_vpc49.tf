...
API Information:
 ...
 - Distinguished Name: "uni/infra/funcprof/accbundle-wakanda-leaf201-202_vpc49"
GUI Location:
 - Fabric > Interfaces > Leaf Interfaces > Policy Groups > [PC or VPC] Interface > wakanda-leaf201-202_vpc49
*/
resource "aci_leaf_access_bundle_policy_group" "Policy_Group_Bundle_wakanda-leaf201-202_vpc49" {
    depends_on                                  = [
    ...
    lag_t                                       = "node"
    name                                        = "wakanda-leaf201-202_vpc49"
    name_alias                                  = "None"
