/*
 This File will include Policies Related to Tenant "prod" BD "v3011"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v3011"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v3011
*/
resource "aci_bridge_domain" "prod_v3011" {
