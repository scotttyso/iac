/*
 This File will include Policies Related to Tenant "prod" BD "v0998"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v0998"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v0998
*/
resource "aci_bridge_domain" "prod_v0998" {
