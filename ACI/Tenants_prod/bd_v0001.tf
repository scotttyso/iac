/*
 This File will include Policies Related to Tenant "prod" BD "v0001"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v0001"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v0001
*/
resource "aci_bridge_domain" "prod_v0001" {
