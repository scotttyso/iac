/*
 This File will include Policies Related to Tenant "prod" BD "v0064"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v0064"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v0064
*/
resource "aci_bridge_domain" "prod_v0064" {
