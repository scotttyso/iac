/*
 This File will include Policies Related to Tenant "prod" BD "v3003"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v3003"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v3003
*/
resource "aci_bridge_domain" "prod_v3003" {
