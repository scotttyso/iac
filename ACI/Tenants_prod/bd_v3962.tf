/*
 This File will include Policies Related to Tenant "prod" BD "v3962"
*/

/*
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v3962"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v3962
*/
resource "aci_bridge_domain" "prod_v3962" {
