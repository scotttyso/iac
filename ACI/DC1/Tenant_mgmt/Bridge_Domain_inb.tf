...
resource "aci_bridge_domain" "Tenant_mgmt_Bridge_Domain_inb" {
    ...
    relation_fv_rs_bd_to_out                    = [aci_l3_outside.Tenant_mgmt_L3Out_inband_L3.id]
...
*/
resource "aci_subnet" "Tenant_mgmt_Bridge_Domain_inb_Subnet_198-18-11-0_24" {
    depends_on                          = [
        aci_tenant.Tenant_mgmt,
