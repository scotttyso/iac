...
resource "aci_logical_interface_profile" "common_l3out_dc1-dmz_L3_nodep_dc1-leaf202_node_intfp_Eth1-48" {
    depends_on                                      = [
        aci_tenant.common,
        aci_l3_outside.common_l3out_dc1-dmz_L3,
        aci_logical_node_profile.common__l3out_dc1-dmz_L3_nodep_dc1-leaf202
    ]
    logical_node_profile_dn                         = aci_logical_node_profile.common__l3out_dc1-dmz_L3_nodep_dc1-leaf202.id
