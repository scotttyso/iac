...
resource "aci_logical_interface_profile" "common_l3out_dc1-dmz_L3_nodep_dc1-leaf201_node_intfp_Eth1-48" {
    depends_on                                      = [
        aci_tenant.common,
        aci_l3_outside.common_l3out_dc1-dmz_L3,
        aci_logical_node_profile.common_l3out_dc1-dmz_L3_nodep_dc1-leaf201
    ]
    logical_node_profile_dn                         = aci_logical_node_profile.common_l3out_dc1-dmz_L3_nodep_dc1-leaf201.id
...
*/
resource "aci_l3out_path_attachment" "common_l3out_dc1-dmz_L3_nodep_dc1-leaf201_node_intfp_Eth1-48_path_attachment" {
    depends_on                      = [
        aci_tenant.common,
        aci_logical_node_profile.common_l3out_dc1-dmz_L3_nodep_dc1-leaf201,
        aci_logical_interface_profile.common_l3out_dc1-dmz_L3_nodep_dc1-leaf201_node_intfp_Eth1-48
    ]
    logical_interface_profile_dn    = aci_logical_interface_profile.common_l3out_dc1-dmz_L3_nodep_dc1-leaf201_node_intfp_Eth1-48.id
