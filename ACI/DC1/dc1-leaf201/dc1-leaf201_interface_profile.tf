...
*/
resource "aci_leaf_interface_profile" "int_profile_dc1-leaf201" {
    # annotation  = 
    name        = dc1-leaf201
    # name_alias  = 
}
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-01" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
    name                            = "Eth1-01"
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-01
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-01" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-01
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-01.id
    name                    = "Eth1-01"
    from_card               = "1"
    from_port               = "1"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-02" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-02
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-02" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-02
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-02.id
    name                    = "Eth1-02"
    from_card               = "1"
    from_port               = "2"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-03" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
    ...
    name                            = "Eth1-03"
    access_port_selector_type       = "range"
    relation_infra_rs_acc_base_grp  = "uni/infra/funcprof/accportgrp-accessPort"
}
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-03
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-03" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-03
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-03.id
    description             = "143c-lab-gw1-Te0/0/4"
    name                    = "Eth1-03"
    from_card               = "1"
    from_port               = "3"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-04" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-04
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-04" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-04
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-04.id
    description             = "143c-lab-gw1-Te0/0/5"
    name                    = "Eth1-04"
    from_card               = "1"
    from_port               = "4"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-05" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-05
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-05" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-05
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-05.id
    name                    = "Eth1-05"
    from_card               = "1"
    from_port               = "5"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-06" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-06
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-06" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-06
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-06.id
    name                    = "Eth1-06"
    from_card               = "1"
    from_port               = "6"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-07" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-07
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-07" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-07
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-07.id
    name                    = "Eth1-07"
    from_card               = "1"
    from_port               = "7"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-08" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-08
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-08" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-08
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-08.id
    name                    = "Eth1-08"
    from_card               = "1"
    from_port               = "8"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-09" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-09
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-09" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-09
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-09.id
    name                    = "Eth1-09"
    from_card               = "1"
    from_port               = "9"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-10" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-10
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-10" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-10
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-10.id
    name                    = "Eth1-10"
    from_card               = "1"
    from_port               = "10"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-11" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-11
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-11" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-11
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-11.id
    name                    = "Eth1-11"
    from_card               = "1"
    from_port               = "11"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-12" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-12
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-12" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-12
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-12.id
    name                    = "Eth1-12"
    from_card               = "1"
    from_port               = "12"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-13" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-13
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-13" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-13
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-13.id
    name                    = "Eth1-13"
    from_card               = "1"
    from_port               = "13"
    to_card                 = "1"
...
*/
resource "aci_access_port_selector" "selector_dc1-leaf201_Eth1-14" {
    depends_on                      = [
        aci_leaf_interface_profile.dc1-leaf201
    ]
    leaf_interface_profile_dn       = aci_leaf_interface_profile.int_profile_dc1-leaf201.id
...
GUI Location:
 - Fabric > Access Policies > Interfaces > Leaf Interfaces > Profiles > dc1-leaf201:Eth1-14
*/
resource "aci_access_port_block" "port_block_dc1-leaf201_Eth1-14" {
    depends_on              = [
        aci_access_port_selector.selector_dc1-leaf201_Eth1-14
    ]
    access_port_selector_dn = aci_access_port_selector.selector_dc1-leaf201_Eth1-14.id
    name                    = "Eth1-14"
    from_card               = "1"
    from_port               = "14"
    to_card                 = "1"
