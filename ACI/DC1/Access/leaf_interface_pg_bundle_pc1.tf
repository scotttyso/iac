...
API Information:
 ...
 - Distinguished Name: "uni/infra/funcprof/accbundle-pc1"
GUI Location:
 - Fabric > Interfaces > Leaf Interfaces > Policy Groups > [PC or VPC] Interface > pc1
*/
resource "aci_leaf_access_bundle_policy_group" "pc1" {
    depends_on                                  = [
