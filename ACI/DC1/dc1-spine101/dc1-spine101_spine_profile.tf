...
resource "aci_spine_profile" "dc1-spine101" {
    depends_on                      = [
        aci_spine_interface_profile.dc1-spine101
    ]
    # annotation                      = ""
    ...
    relation_infra_rs_sp_acc_port_p = [
        aci_spine_interface_profile.dc1-spine101.id
    ]
}
...
API Information:
 - Class: "infraSpineS"
 - Distinguished Name: "uni/infra/spprof-dc1-spine101/spines-dc1-spine101-typ-{switch_association_type}"
GUI Location:
...
resource "aci_spine_switch_association" "dc1-spine101" {
    depends_on                              = [
        aci_spine_profile.dc1-spine101,
...
resource "aci_rest" "spine_node_block_blk101-101" {
    depends_on                              = [
        aci_spine_profile.dc1-spine101,
        aci_spine_switch_association.dc1-spine101
    ]
    ...
    payload     = <<EOF
{
    "infraNodeBlk": {
        "attributes": {
            "dn": "uni/infra/spprof-dc1-spine101/spines-dc1-spine101-typ-range/nodeblk-blk101-101",
            "from_": "101",
            "to_": "101",
            "name": "blk101-101",
        },
