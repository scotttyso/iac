...
*/
resource "aci_bridge_domain" "dmz_v0995" {
    depends_on                                  = [
        aci_tenant.dmz,
        data.aci_tenant.dmz,
        data.aci_vrf.dmz_dmz,
        data.aci_l3_outside.dmz_l3out_None
    ]
    tenant_dn                                   = data.ci_tenant.dmz.id
    ...
    unk_mcast_act                               = "flood"
    relation_fv_rs_ctx                          = aci_vrf.dmz_dmz.id
