...
resource "aci_logical_interface_profile" "infra_l3out_msite_L3_nodep_dc2-spine101_node_intfp_Eth1-01_4" {
    depends_on                                      = [
        aci_tenant.infra,
        aci_l3_outside.infra_l3out_msite_L3,
        aci_logical_node_profile.infra_l3out_msite_L3_nodep_dc2-spine101
    ]
    logical_node_profile_dn                         = aci_logical_node_profile.infra_l3out_msite_L3_nodep_dc2-spine101.id
...
*/
resource "aci_l3out_path_attachment" "infra_l3out_msite_L3_nodep_dc2-spine101_node_intfp_Eth1-01_4_path_attachment" {
    depends_on                      = [
        aci_tenant.infra,
        aci_logical_node_profile.infra_l3out_msite_L3_nodep_dc2-spine101,
        aci_logical_interface_profile.infra_l3out_msite_L3_nodep_dc2-spine101_node_intfp_Eth1-01_4
...
GUI Location:
 ...
 - Assign all the default Policies to this Policy Group
*/
resource "aci_l3out_path_attachment" "infra_l3out_msite_L3_nodep_dc2-spine101_node_intfp_Eth1-02_4_path_attachment" {
    depends_on                      = [
        aci_tenant.infra,
        aci_logical_node_profile.infra_l3out_msite_L3_nodep_dc2-spine101,
        aci_logical_interface_profile.infra_l3out_msite_L3_nodep_dc2-spine101_node_intfp_Eth1-02_4
