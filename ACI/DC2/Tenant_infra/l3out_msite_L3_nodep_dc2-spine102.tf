...
resource "aci_logical_interface_profile" "infra_l3out_msite_L3_nodep_dc2-spine102_node_intfp_Eth1-01_4" {
    depends_on                                      = [
        aci_tenant.infra,
        aci_l3_outside.infra_l3out_msite_L3,
        aci_logical_node_profile.infra__l3out_msite_L3_nodep_dc2-spine102
    ]
    logical_node_profile_dn                         = aci_logical_node_profile.infra__l3out_msite_L3_nodep_dc2-spine102.id
