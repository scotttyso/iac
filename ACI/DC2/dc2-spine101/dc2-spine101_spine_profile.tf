...
resource "aci_spine_profile" "dc2-spine101" {
    depends_on                      = [
        aci_spine_interface_profile.dc2-spine101
    ]
    # annotation                      = ""
    ...
    relation_infra_rs_sp_acc_port_p = [
        aci_spine_interface_profile.dc2-spine101.id
    ]
}
...
resource "aci_spine_switch_association" "dc2-spine101" {
    depends_on                              = [
        aci_spine_profile.dc2-spine101,
...
resource "aci_rest" "spine_node_block_blk101-101" {
    depends_on                              = [
        aci_spine_profile.dc2-spine101,
        aci_spine_switch_association.dc2-spine101
    ]
