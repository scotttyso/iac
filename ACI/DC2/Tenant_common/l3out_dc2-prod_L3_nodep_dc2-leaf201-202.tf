...
resource "aci_logical_interface_profile" "common_l3out_dc2-prod_L3_nodep_dc2-leaf201-202_node_intfp_Vlan921" {
    depends_on                                      = [
        aci_tenant.common,
        aci_l3_outside.common_l3out_dc2-prod_L3,
        aci_logical_node_profile.common__l3out_dc2-prod_L3_nodep_dc2-leaf201-202
    ]
    logical_node_profile_dn                         = aci_logical_node_profile.common__l3out_dc2-prod_L3_nodep_dc2-leaf201-202.id
