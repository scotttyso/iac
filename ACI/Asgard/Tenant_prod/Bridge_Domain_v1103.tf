...
API Information:
 - Class: "fvBD"
 - Distinguised Name: "/uni/tn-prod/BD-v1103"
GUI Location:
 - Tenants > prod > Networking > Bridge Domains > v1103
*/
resource "aci_bridge_domain" "Tenant_prod_Bridge_Domain_v1103" {
    depends_on                                  = [
