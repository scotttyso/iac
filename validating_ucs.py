...
def dns_name(var, var_value):
    ...
    if not valid_count == 0:
        print(f'\n--------------------------------------------------------------------------------\n')
        print(f'   Error with {var}.  "{var_value}" is not a valid Hostname.')
...
def ip_address(var, var_value):
    ...
    if not valid_count == 0 and re.search(r'\.', address):
        print(f'\n-----------------------------------------------------------------------------\n')
        print(f'   Error with {var}. "{var_value}" is not a valid IPv4 Address.')
        print(f'\n-----------------------------------------------------------------------------\n')
        return False
...
def name_rule(var, var_value, minx, maxx):
    if not (re.search(r'^[a-zA-Z0-9_-]+$',  var_value) and validators.length(str(var_value), min=int(minx), max=int(maxx))):
        print(f'\n-----------------------------------------------------------------------------\n')
        print(f'   Error with {var}!!  "{var_value}" failed one of the complexity tests:')
        print(f'    - Min Length {minx}')
        print(f'    - Max Length {maxx}')
...
def org_rule(var, var_value, minx, maxx):
    if not (re.search(r'^[a-zA-Z0-9:_-]+$',  var_value) and validators.length(str(var_value), min=int(minx), max=int(maxx))):
        print(f'\n-----------------------------------------------------------------------------\n')
        print(f'   Error with {var}!!  "{var_value}" failed one of the complexity tests:')
        print(f'    - Min Length {minx}')
