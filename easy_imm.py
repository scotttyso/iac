...
def process_wizard():
    ...
    ## type = 'pools'
    ## lib_ucs.easy_imm_wizard(org, type).ip_pools()
    ## lib_ucs.easy_imm_wizard(org, type).iqn_pools()
    ## lib_ucs.easy_imm_wizard(org, type).mac_pools()
    ## lib_ucs.easy_imm_wizard(org, type).wwnn_pools()
    ## lib_ucs.easy_imm_wizard(org, type).wwpn_pools()
    ## lib_ucs.easy_imm_wizard(org, type).uuid_pools()
    type = 'policies'
    lib_ucs.easy_imm_wizard(org, type).bios_policies()
    ## lib_ucs.easy_imm_wizard(org, type).boot_order_policies()
    lib_ucs.easy_imm_wizard(org, type).ethernet_adapter_policies()
    ## lib_ucs.easy_imm_wizard(org, type).ethernet_network_control_policies()
    ## lib_ucs.easy_imm_wizard(org, type).ethernet_network_group_policies()
    ## lib_ucs.easy_imm_wizard(org, type).ethernet_network_policies()
    ## lib_ucs.easy_imm_wizard(org, type).ethernet_qos_policies()
    ## lib_ucs.easy_imm_wizard(org, type).fibre_channel_adapter_policies()
    ## lib_ucs.easy_imm_wizard(org, type).fibre_channel_network_policies()
    ## lib_ucs.easy_imm_wizard(org, type).fibre_channel_qos_policies()
    # lib_ucs.easy_imm_wizard(org, type).flow_control_policies()
    ## lib_ucs.easy_imm_wizard(org, type).imc_access_policies()
    ## lib_ucs.easy_imm_wizard(org, type).ipmi_over_lan_policies()
    ## lib_ucs.easy_imm_wizard(org, type).iscsi_adapter_policies()
    ## lib_ucs.easy_imm_wizard(org, type).iscsi_boot_policies()
    ## lib_ucs.easy_imm_wizard(org, type).iscsi_static_target_policies()
    ## lib_ucs.easy_imm_wizard(org, type).lan_connectivity_policies()
    # lib_ucs.easy_imm_wizard(org, type).link_aggregation_policies()
    # lib_ucs.easy_imm_wizard(org, type).link_control_policies()
    dns_policies = []
    dns_policies = lib_ucs.easy_imm_wizard(org, type).network_connectivity_policies()
    ntp_policies = []
    ntp_policies = lib_ucs.easy_imm_wizard(org, type).ntp_policies()
    # lib_ucs.easy_imm_wizard(org, type).port_policies()
    ## lib_ucs.easy_imm_wizard(org, type).power_policies()
    ## lib_ucs.easy_imm_wizard(org, type).san_connectivity_policies()
    ## lib_ucs.easy_imm_wizard(org, type).sd_card_policies()
    ## lib_ucs.easy_imm_wizard(org, type).serial_over_lan_policies()
    # lib_ucs.easy_imm_wizard(org, type).snmp_policies()
    ## lib_ucs.easy_imm_wizard(org, type).storage_policies()
    # lib_ucs.easy_imm_wizard(org, type).switch_control_policies()
    # lib_ucs.easy_imm_wizard(org, type).syslog_policies()
    # lib_ucs.easy_imm_wizard(org, type).system_qos_policies()
    ## lib_ucs.easy_imm_wizard(org, type).thermal_policies()
    ## lib_ucs.easy_imm_wizard(org, type).virtual_kvm_policies()
    ## lib_ucs.easy_imm_wizard(org, type).virtual_media_policies()
    # lib_ucs.easy_imm_wizard(org, type).vsan_policies()
    # type = 'policies_vlans'
    # lib_ucs.easy_imm_wizard(org, type).multicast_policies()
    # lib_ucs.easy_imm_wizard(org, type).vlan_policies()
    type = 'ucs_domain_profiles'
    lib_ucs.easy_imm_wizard(org, type).ucs_domain_profiles(dns_policies, ntp_policies)
    ## type = 'ucs_server_profiles'
